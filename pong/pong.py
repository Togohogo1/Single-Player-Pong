...
def main():
    ...
    while menu:
        ...
        howtowin = text_format("Get 15 points to win. Each time the ball hits the paddle, it gets harder", 'freesansbold.ttf', 20, YELLOW)
        #sets the 'rules' text font size and colour
        rules = text_format("Press right and left to choose. When 'QUIT' or 'START' is green, press enter.", 'freesansbold.ttf', 20, YELLOW)
